...
public class PlayerControllerPlateformer : MonoBehaviour
{
    ...
    #region RUN BEHAVIOR
    public float runMaxSpeed = 10;

    public float runAccelAmount = 30;

    public bool doConserveMomentum = false;

    public float runDeccelAmount = 1f;

    public float accelInAir = 1f;

    public float unDeccelAmount = 1f;
    ...
    private void Awake()
	{
        ...
        playerInput.CharacterControls.Move.performed += onRun;
    ...
    private void onRun(InputAction.CallbackContext context)
	{
		...
		if (LastOnGroundTime > 0)
			...
			accelRate = (Mathf.Abs(targetSpeed) > 0.01f) ? runAccelAmount * accelInAir : unDeccelAmount * deccelInAir;
		#endregion
